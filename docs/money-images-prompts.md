...
**Visual Concept**: Large smartphone with code prominently displayed, balanced layout

#### English

```
Clean flat 2D illustration, gradient background (light sky blue #87CEEB at top
fading to soft white at bottom), modern minimal style.

TOP TEXT: "Wealthsimple Referral Code: Get $25 Cash Bonus"
in BOLD white text with dark blue outline and subtle glow effect - make it POP

CENTER HERO (takes up 50% of image): Large smartphone with DROP SHADOW to make it pop.
Held by two SIMPLE ILLUSTRATED HANDS (cartoon-style, not realistic - 4 fingers visible,
clean lines, no weird proportions).
On the phone screen:
- Wealthsimple "W" logo at top
- Text: "Enter Referral Code"
- Large input field showing "9C6DMQ" in bold black text (focal point)
- Green "Get $25 Bonus!" button below

BALANCED SIDE ELEMENTS:
- LEFT: Gift box with "$25" label
- RIGHT: Large stylized "2026" with green checkmark (✓) below it

Canadian flag icon in top right corner.

Style: Clean, balanced. Phone should have drop shadow to stand out.
Simple cartoon hands only - avoid photorealistic hands.
```
...
TOP TEXT: "Code de parrainage Wealthsimple : Obtenez 25 $"
in bold white text with dark blue outline

CENTER HERO (takes up 50% of image): Large smartphone held by two illustrated hands.
On the phone screen:
- Wealthsimple "W" logo at top
- Text: "Entrez le code de parrainage"
- Large input field showing "9C6DMQ" in bold black text (focal point)
- Green "Obtenez 25 $!" button below
...
Style: Clean, balanced. Hands holding phone.
```
