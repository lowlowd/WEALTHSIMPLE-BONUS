...
imageCaption: 'Wealthsimple Core, Premium, and Generation tier comparison'
category: Guides
tags:
...
**Premium** is really the "sweet spot" for serious investors in Canada. Hit $100,000 in net deposits across all your Wealthsimple accounts, and you'll unlock these upgrades automatically.
...
- Staking reward cut reduced from 30% to 20%
...
**Generation** is Wealthsimple's answer to private banking. It targets high-net-worth individuals who might otherwise use full-service wealth managers.

### What Changes at Generation
...
Yes, these assets have different liquidity rules than stocks. Unlike ETFs which can be sold instantly during market hours, Private Credit and Private Equity funds typically have specific monthly or quarterly "redemption windows." In times of high market stress, there may be limits on how much can be withdrawn at once.

### Do Generation clients still get DragonPass lounge access?

Yes, but it is part of the "Milestone Rewards" system. Once you reach the required asset level, you can select the 10 DragonPass lounge visits as your reward for the year. This is separate from any lounge access provided by the Wealthsimple Visa Infinite Privilege card.
...
[^4]: Wealthsimple - Credit Card: https://www.wealthsimple.com/en-ca/credit-card

[^5]: Wealthsimple - Household Feature: https://help.wealthsimple.com/hc/en-ca/articles/14557325627803
