...
imageCaption: 'Comparatif des paliers Wealthsimple Core, Premium et Génération'
category: Comparaisons
tags:
  - wealthsimple premium
  - wealthsimple génération
  - paliers wealthsimple
  - gestion de patrimoine canada
metadata:
  canonical: https://wealthsimplebonus.ca/fr/blogue/core-vs-premium-vs-generation
faqs:
  - question: 'Comment puis-je passer au palier Premium ?'
    answer: 'Vous passez automatiquement au palier Premium lorsque vos dépôts nets atteignent 100 000 $. Aucune action requise—le système met à jour votre statut automatiquement.'
  - question: 'Les dépôts nets incluent-ils mes gains de placement ?'
    answer: 'Non, les dépôts nets sont calculés comme vos dépôts totaux moins vos retraits totaux. Les gains ou pertes de marché ne comptent pas.'
  - question: "Puis-je rétrograder si je retire de l'argent ?"
    answer: 'Oui, si vos dépôts nets tombent sous le seuil du palier, vous serez rétrogradé au palier inférieur lors du prochain cycle de calcul.'
  - question: 'Le palier Premium en vaut-il la peine juste pour le compte USD gratuit ?'
...
```
Dépôts nets = Dépôts totaux − Retraits totaux
```
...
1. **Consolidez vos comptes :** Transférez REER, CELI et non-enregistré d'autres institutions
2. **Maximisez vos cotisations :** CELI (7 000 $) + REER + CELIAPP s'accumulent rapidement
3. **Transférez pour le remboursement des frais :** Transferts de 25 000 $+ = frais remboursés

### Pour atteindre Génération (500 K$)

1. **Patrimoine familial :** Certains clients combinent les comptes familiaux
2. **Transferts de succession :** Héritages peuvent vous qualifier rapidement
3. **Vente d'entreprise :** Produits de vente d'entreprise
