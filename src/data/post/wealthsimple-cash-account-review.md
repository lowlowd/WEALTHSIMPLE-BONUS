...
\*Direct deposit boost requires $2,000+ monthly deposit from payroll or government payments.
...
The physical card you receive with your Cash account is a **prepaid Mastercard**—not a traditional debit card.

### Key Features

**No Foreign Transaction Fees:**
This is the standout feature. Most Canadian credit and debit cards charge **2.5%** on foreign currency purchases. Wealthsimple charges **0%**.
...
Access ATMs in the Exchange and Cirrus networks without fees. Third-party ATM fees are reimbursed.
...
By spreading deposits across multiple partner banks, Wealthsimple provides **up to $1,000,000 in CDIC coverage**—10x the standard protection at a single bank.
...
For Generation clients ($500K+), Wealthsimple offers access to private credit investments.
...
Base rate is 1.25% for Core clients, increasing to 1.75% for Premium and 2.25% for Generation. A 0.5% boost is available with $2,000+/month direct deposit.
...
Yes! Costco Canada accepts Mastercard, so the Wealthsimple prepaid Mastercard works perfectly there. This is a common question since Costco previously only accepted Amex.
...
Yes. Wealthsimple does not charge ATM fees, and they also reimburse the fee charged by the ATM operator (e.g., the $3.00 fee from a CIBC ATM) for eligible withdrawals worldwide. This reimbursement typically appears in your account shortly after the transaction settles.
