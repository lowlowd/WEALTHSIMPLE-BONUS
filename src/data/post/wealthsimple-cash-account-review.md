...
updateDate: 2025-01-08T00:00:00Z
title: 'Wealthsimple Cash Account Review 2025: Interest Rates, Features & Card'
excerpt: 'A complete review of the Wealthsimple Cash account in 2025. Learn about current interest rates, the prepaid Mastercard, foreign transaction fees, and CDIC coverage.'
...
faqs:
  - question: 'What is the Wealthsimple Cash interest rate in 2025?'
    answer: 'Rates range from 0.75% to 2.25% depending on client status and direct deposit eligibility. Core clients get 0.75% base, Premium gets 1.75%, and Generation gets the maximum 2.25%. A 0.5% boost is available for eligible Core/Premium clients with qualifying direct deposits.'
  ...
  - question: 'Does Wealthsimple reimburse ATM fees charged by other banks?'
    answer: 'Yes, within Canada. Wealthsimple reimburses unlimited ATM fees up to $5 each within about 4 business days. Note: The marketing page claims worldwide coverage, but the help centre specifies Canada only—confirm with Wealthsimple if traveling abroad.'
...
Interest rates on the Wealthsimple Cash account vary based on your client tier and direct deposit status. Keep in mind that the Wealthsimple cash account interest rate fluctuates with the market—specifically, it moves with Bank of Canada rate decisions. As of December 2025 (following the November rate cut), here are the current rates:
...
This is the standout feature. Most Canadian credit and debit cards charge **2.5%** on foreign currency purchases.[^2] Wealthsimple charges **0%**.
...
**1% Cash Back:**
Earn 1% rewards on purchases made with the card.

**Mobile Wallet Support:**
Works with Apple Pay, Google Pay, and Samsung Pay.

**ATM Fee Reimbursement:**
Wealthsimple reimburses ATM fees (up to $5 per transaction) for withdrawals within Canada. Reimbursement typically appears within about 4 business days after the transaction settles.

> **⚠️ Policy Discrepancy:** Wealthsimple's marketing page states "Get ATM fees reimbursed for withdrawals from anywhere in the world," but their help centre policy specifies that ATM fee reimbursements are only for withdrawals within Canada.[^3] It's unclear whether worldwide ATM fees are currently refundable—we recommend confirming with Wealthsimple directly if you plan to use ATMs abroad.

### Limitations

**Not Interac Debit:**
The Wealthsimple card is a prepaid Mastercard, not an Interac debit card. This means:
...
**Loading Limits:**
As a prepaid card, there may be limits on how much you can spend in a single transaction. These are generally high enough for everyday use.

## USD Account Features

For users who hold US dollars (for US stock dividends, USD income, etc.), Wealthsimple offers a USD account:
...
## CDIC Insurance: Up to $1 Million

One of Wealthsimple's strongest features is its deposit insurance structure.

### How It Works

Wealthsimple partners with multiple federally regulated banks to hold your deposits. Each partner bank provides up to $100,000 in CDIC coverage per account type.
...
## Private Credit Fund (Generation Tier)

For Generation clients ($500K+), Wealthsimple offers access to private credit investments.[^5]
...
This product is designed for sophisticated investors who understand the risks and want diversification beyond public markets.

## Opening a Wealthsimple Cash Account

Getting started is simple:

1. **[Sign up with referral code 9C6DMQ](https://wealthsimple.com/invite/9C6DMQ)** — Get a $25 bonus
2. Complete identity verification (takes minutes)
3. Your Cash/Chequing account is automatically opened
4. Order your free prepaid Mastercard
5. Link your bank account and transfer funds
...
✅ **Emergency funds** — High interest + CDIC protection
✅ **Travel** — No foreign transaction fees
✅ **Everyday banking** — Modern app, instant transfers
✅ **Wealthsimple investors** — Seamless integration with trading accounts

### Maybe Not For:

❌ **People who need Interac-only payments** — Prepaid Mastercard has limitations
❌ **Complex banking needs** — No mortgages, lines of credit, etc.

## Wealthsimple Cash vs. EQ Bank

EQ Bank is another popular high-interest alternative. Here's how they compare:
...
| FX Fees                | 0%                | 1.5%             |
| CDIC Coverage          | Up to $1M         | $100K[^6]        |
| Investment Integration | Full              | Limited          |

**EQ Bank wins on:** Slightly higher max rate with direct deposit (2.75% vs 2.25%)

**Wealthsimple wins on:** No FX fees, higher CDIC coverage, investing integration

With recent Bank of Canada rate cuts, both platforms now offer similar interest rates. The choice comes down to whether you value travel-friendly banking (Wealthsimple) or slightly higher savings interest (EQ Bank).
...
👉 **[Sign up with code 9C6DMQ](https://wealthsimple.com/invite/9C6DMQ)** and get your Wealthsimple sign up bonus of $25 today.
...
### What is the Wealthsimple Cash interest rate in 2025?
...
The best sign up bonus is the referral code **9C6DMQ**—you get $25 cash for just a $1 deposit, plus it goes directly into your Cash account and starts earning interest immediately.
...
Yes, for Canadian ATM withdrawals. Wealthsimple reimburses an unlimited number of ATM fees up to $5 each, with reimbursement typically appearing within about 4 business days after the transaction settles.

**Important Policy Discrepancy:** Wealthsimple's marketing page claims ATM fees are reimbursed "for withdrawals from anywhere in the world," but their help centre policy explicitly states reimbursements are only for ATM withdrawals within Canada. It's currently unclear whether worldwide ATM fees are refundable—Canadian withdrawals are definitely covered up to $5 each, but if you're traveling internationally, we recommend confirming with Wealthsimple before relying on ATM fee reimbursement.
