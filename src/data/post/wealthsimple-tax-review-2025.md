...
- Is **CRA NETFILE certified** for electronic filing
...
| Plan     | Cost                   | Features                        |
| -------- | ---------------------- | ------------------------------- |
| **Free** | $0 (optional donation) | Full tax filing capabilities    |
| **Plus** | $29.99                 | Priority support, audit defense |
| **Pro**  | $89.99                 | Expert review, 1-on-1 advice    |

Most users never need more than the free tier. Seriously.
...
Wealthsimple Tax guarantees that if you owe penalties or interest due to a calculation error they made, they'll pay the difference.
...
The previous mobile app was discontinued. You can still access Wealthsimple Tax through your mobile browser, but it's optimized for desktop.
...
The free version allows up to 20 returns per account—plenty for most people, but a limit for those doing taxes for many family members.
...
If you're an executor handling an estate, note that Wealthsimple Tax supports the final T1 return for a deceased individual, but does **not** support T3 Trust Income Tax returns for the estate itself. You'll need separate software or an accountant for that.
...
Yes. If you hold foreign property with a total cost of over $100,000 CAD, Wealthsimple Tax fully supports Form T1135. It will guide you through using either the Simplified Reporting Method (Part A) or the Detailed Reporting Method (Part B) depending on your asset value.
...
Yes. Wealthsimple Tax allows you to prepare and file returns going back to the 2016 tax year. You will need to select the specific tax year you wish to file from the dropdown menu in your dashboard.
