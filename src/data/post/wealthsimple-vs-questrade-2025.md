...
## Trading Fees: Both Are Now Commission-Free

As of early 2025, both Wealthsimple and Questrade offer **$0 commission trading** for Canadian and US stocks and ETFs.
...
## Currency Conversion: This Is the Big One

Here's where the two platforms really differ—and if you're buying US stocks regularly, pay attention:
...
1. **USD in Registered Accounts:** Questrade lets you hold USD in your TFSA, RRSP, etc.—all users, no subscription
2. **Norbert's Gambit:** Convert CAD to USD for virtually $0 using an interlisted security

### What Is Norbert's Gambit?

Norbert's Gambit is a technique to convert currency at minimal cost:

1. Buy a stock listed on both TSX (CAD) and NYSE (USD) — e.g., Royal Bank (RY)
2. Journal the shares from the CAD side to the USD side
3. Sell the shares for USD
4. Total cost: ~0.05% vs 1.5% with direct conversion

**Questrade actively supports this.** You can journal shares between currencies for minimal or no fee.

**Wealthsimple** has teased Norbert's Gambit support for early 2026, but as of late 2025, it's not yet available.
...
Options trading is where active traders see meaningful differences:

|                      | Wealthsimple              | Questrade        |
| -------------------- | ------------------------- | ---------------- |
| **Commission**       | $0                        | $0               |
| **Per-Contract Fee** | $0.75-$2 USD              | $0.99 USD        |
| **Tier Pricing**     | Core: $2, Premium+: $0.75 | All users: $0.99 |

**Questrade wins** for Core-tier Wealthsimple users ($2 vs $0.99).

**Wealthsimple wins** for Premium/Generation users ($0.75 vs $0.99).

Both platforms now support advanced strategies like spreads and iron condors.

## Robo-Advisor: Managed Portfolios

If you prefer hands-off investing:
...
Both platforms will reimburse transfer-out fees from your old institution:
...
If you want direct crypto exposure in the same app as your stocks, Wealthsimple offers it. Questrade only offers crypto through ETFs.
...
- Trade options frequently at Core-tier levels

## What About Interactive Brokers?

Some advanced traders ask about Interactive Brokers (IBKR) as a third option. Here's the quick take:
...
And here's one more thing. Wealthsimple has a robust referral program that gives you **$25+ cash** just for signing up with a referral code.

Questrade has referral offers, but they're less consistent and typically require higher deposits. However, if you do decide to go with Questrade, you can use the referral code **406714313487116** or this [direct link](https://questmobile.onelink.me/tX0y/419708l0) to claim the welcome bonus (typically $50 for a $250 deposit).
...
For CAD investing, they're essentially identical. For USD investing, Questrade is cheaper unless you have $100K+ at Wealthsimple (which gives you free USD accounts).
...
Wealthsimple has announced that support for Norbert's Gambit (a method to convert CAD to USD cheaply) is scheduled for release in early 2026. Until then, you must pay the 1.5% FX fee or subscribe to the USD accounts to avoid conversion fees on every trade.
